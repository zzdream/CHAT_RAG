...
.rag-sidebar__new:hover:not(:disabled) {
  border-color: var(--accent);
  background: var(--accent-soft);
  box-shadow: var(--shadow-sm);
}

.rag-sidebar__new:disabled {
  opacity: 0.5;
  cursor: not-allowed;
}

.rag-sidebar__new-icon {
  display: grid;
  place-items: center;
  width: 20px;
  height: 20px;
...
.rag-sidebar__section {
  padding: 0 0 8px;
}

.rag-sidebar__section--grow {
  flex: 1;
  min-height: 0;
  display: flex;
  flex-direction: column;
...
.rag-sidebar__kb-dropdown {
  width: 100%;
}

.rag-sidebar__kb-dropdown :deep(.ant-select-selector) {
...
.rag-sidebar__kb-dropdown :deep(.ant-select-selection-search),
.rag-sidebar__kb-dropdown :deep(.ant-select-selection-wrap) {
  display: flex;
  align-items: center;
  height: 100%;
}

.rag-sidebar__kb-dropdown :deep(.ant-select-selection-item),
.rag-sidebar__kb-dropdown :deep(.ant-select-selection-placeholder) {
  color: var(--text-primary);
...
.rag-sidebar__kb-dropdown :deep(.ant-select-arrow) {
  color: var(--text-muted);
  top: 50% !important;
...
.rag-sidebar__kb-dropdown:not(.ant-select-disabled):hover :deep(.ant-select-selector) {
  border-color: var(--border-strong) !important;
}

.rag-sidebar__kb-dropdown.ant-select-focused :deep(.ant-select-selector) {
  border-color: var(--accent) !important;
  box-shadow: 0 0 0 2px var(--accent-ring) !important;
}

.rag-sidebar__session-list {
  list-style: none;
  margin: 0;
  padding: 0;
  flex: 1;
...
.rag-sidebar__session-item:hover {
  background: var(--bg-elevated);
}

.rag-sidebar__session-item--active {
  background: var(--accent-soft);
}

.rag-sidebar__session-item--active .rag-sidebar__session-title {
  color: var(--accent);
  font-weight: 600;
}

.rag-sidebar__session-select {
  flex: 1;
  min-width: 0;
  display: flex;
  flex-direction: column;
...
.rag-sidebar__session-time {
  font-size: 11px;
  color: var(--text-muted);
}

.rag-sidebar__session-delete {
  flex-shrink: 0;
  width: 32px;
  margin: 6px 0 6px 0;
  border: none;
...
.rag-sidebar__session-item:hover .rag-sidebar__session-delete,
.rag-sidebar__session-item--active .rag-sidebar__session-delete {
  opacity: 1;
}

.rag-sidebar__session-delete:hover:not(:disabled) {
